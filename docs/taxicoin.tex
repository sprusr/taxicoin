...
% document info
\title{Taxicoin: A Decentralised Taxi Protocol}
\author{Scott Street}
\date{April 2018}
...
\begin{titlepage}
	...
	{\scshape\LARGE Aston University}

	\vspace{0.5cm}

	{\scshape\large Final Year Project\\Computer Science}

	\vspace{2.5cm}

	{\huge\bfseries Taxicoin: A Decentralised Taxi Protocol}

	\vspace{1cm}

	{\Large\itshape Scott Street}
